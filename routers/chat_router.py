...
def _log_professor_demo(user_text: str, reply: str, algorithm_result: Dict[str, Any]) -> None:
    try:
        ...
        log_msg += f"   - Intent Classifier : {intent_data.get('intent', 'N/A')} (Conf: {intent_data.get('confidence', 'N/A')}, Accepted: {intent_data.get('accepted', 'N/A')})\n"
        log_msg += f"   - Chat Intent       : {style_plan.get('intent', 'N/A')}\n"
